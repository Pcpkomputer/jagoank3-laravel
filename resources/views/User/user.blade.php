...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
          <a href="/admin/user/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
      @foreach($user as $user)
          ...
          <td>
                <a href="/admin/user/update/{{$user->user_id}}"><button class="btn btn-primary mb-3">Update</button></a>
                <a href="/admin/user/delete/{{$user->user_id}}"><button class="btn btn-danger mb-3">Delete</button></a>
          </td>
        </tr>
      @endforeach
  </tbody>
