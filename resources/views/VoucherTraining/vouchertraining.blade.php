...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
          <a href="/admin/vouchertraining/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
         @foreach($vouchertraining as $vouchertraining)
            <tr>
              ...
              <td>
                    <a href="/admin/vouchertraining/update/{{$vouchertraining->id_vouchertraining}}"><button class="btn btn-primary mb-3">Update</button></a>
                    <a href="/admin/vouchertraining/delete/{{$vouchertraining->id_vouchertraining}}"><button class="btn btn-danger mb-3">Delete</button></a>
              </td>
            </tr>
         @endforeach
  </tbody>
