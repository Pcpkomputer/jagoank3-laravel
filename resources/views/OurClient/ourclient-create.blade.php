  ...
  @include("Components.sidebar", array("selected"=>"ourclient"))
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Our Client</h1>
      </div>
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group mb-2">
          ...
          <input required name="client" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Title">
        </div>
        <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputPassword1">Gambar</label>
          <input accept="image/*" required name="foto" type="file" class="form-control">
        </div>
