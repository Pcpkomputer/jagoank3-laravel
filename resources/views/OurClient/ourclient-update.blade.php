  ...
  @include("Components.sidebar", array("selected"=>"ourclient"))
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">ID Client</label>
          <input readonly name="id" value="{{$ourclient->id_ourclient}}" type="text" class="form-control" aria-describedby="emailHelp" placeholder="ID Galeri">
        </div>

        <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">Nama Client</label>
          <input name="client" value="{{$ourclient->nama_client}}" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Title">
        </div>
        <div class="form-group mb-2">
