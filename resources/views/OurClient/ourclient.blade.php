...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    @include("Components.sidebar", array("selected"=>"ourclient"))

    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Our Client</h1>
      </div>
      ...
      <div>
          <a href="/admin/ourclient/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
      @foreach($ourclient as $ourclient) 
          <tr>
          <td>{{$ourclient->id_ourclient}}</td>
          <td>
            <img src="/storage/public/ourclient/{{$ourclient->gambar}}" style="width:230px;height:150px"></img>
          </td>
          <td>{{$ourclient->nama_client}}</td>
          <td>
                <a href="/admin/ourclient/update/{{$ourclient->id_ourclient}}"><button class="btn btn-primary mb-3">Update</button></a>
                <a href="/admin/ourclient/delete/{{$ourclient->id_ourclient}}"><button class="btn btn-danger mb-3">Delete</button></a>
          </td>
        </tr>
      @endforeach
  </tbody>
