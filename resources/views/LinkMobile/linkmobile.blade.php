...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    @include("Components.sidebar", array("selected"=>"linkmobile"))

    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Link PlayStore & AppStore</h1>
      </div>
      ...
      <form method="POST" action="">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="form-group mb-3">
            <label for="exampleInputEmail1">Alamat Playstore</label>
            <input type="text" name="playstore" value="{{$android->link}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Alamat Playstore">
          </div>
          <div class="form-group mb-3">
            <label for="exampleInputEmail1">Alamat Appstore</label>
            <input type="text" name="appstore" value="{{$ios->link}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Alamat Appstore">
          </div>
          <div class="form-group mb-3">
