...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
          <a href="/admin/shop/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
      @foreach($shop as $shop)
          <tr>
              ...
              <td>{{$shop->harga}}</td>
              <td>
                    <a href="/admin/shop/update/{{$shop->id_item}}"><button class="btn btn-primary mb-3">Update</button></a>
                    <a href="/admin/shop/delete/{{$shop->id_item}}"><button class="btn btn-danger mb-3">Delete</button></a>
              </td>
        </tr>
      @endforeach
  </tbody>
