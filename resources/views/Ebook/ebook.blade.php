...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
          <a href="/admin/ebook/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
     ...
     <tr>
         ...
         <td>
                <a href="/admin/ebook/update/{{$ebook->id_ebook}}"><button class="btn btn-primary mb-3">Update</button></a>
                <a href="/admin/ebook/delete/{{$ebook->id_ebook}}"><button class="btn btn-danger mb-3">Delete</button></a>
          </td>
      </tr>
