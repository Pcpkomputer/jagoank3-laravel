...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Sertifikat Training</h1>
      </div>
      ...
      <div>
          <a href="/admin/sertifikat/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
      ...
      <tr>
         ...
         <td>{{$sertifikat->id_training}}</td>
         <td>{{$sertifikat->html}}</td>
         <td>
            <a href="/admin/sertifikat/update/{{$sertifikat->id_sertifikat}}"><button class="btn btn-primary mb-3">Update</button></a>
            <a href="/admin/sertifikat/delete/{{$sertifikat->id_sertifikat}}"><button class="btn btn-danger mb-3">Delete</button></a>
        </td>
      </tr>
      @endforeach
  </tbody>
