    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">Judul Webinar</label>
          <input required name="judul" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Judul Webinar">
        </div>
        <div class="form-group mb-2">
