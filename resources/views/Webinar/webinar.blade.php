...
<div class="container-fluid" style="margin-bottom:35px">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
          <a href="/admin/webinar/create"><button class="btn btn-success mb-3">Tambah</button></a>
      </div>
  ...
  <tbody>
    ...
    <tr>
        <td>{{$webinar->id_webinar}}</td>
        <td>{{$webinar->nama_webinar}}</td>
        <td>{{$webinar->link_youtube}}</td>
        <td>
                <a href="/admin/webinar/update/{{$webinar->id_webinar}}"><button class="btn btn-primary mb-3">Update</button></a>
                <a href="/admin/webinar/delete/{{$webinar->id_webinar}}"><button class="btn btn-danger mb-3">Delete</button></a>
          </td>
      </tr>
    @endforeach
  </tbody>
