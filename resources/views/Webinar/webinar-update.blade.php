...
<div class="container-fluid" style="margin-bottom:35px">
  ...
  @include("Components.sidebar", array("selected"=>"webinar"))

    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Update Webinar</h1>
      </div>
      ...
      <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">ID Webinar</label>
          <input readonly name="id" value="{{$webinar->id_webinar}}" type="text" class="form-control" aria-describedby="emailHelp" placeholder="ID Webinar">
        </div>

        <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">Nama Webinar</label>
          <input name="nama" value="{{$webinar->nama_webinar}}" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Title">
        </div>
        <div class="form-group mb-2">
          <label class="mb-2" for="exampleInputEmail1">Link Youtube</label>
          <input name="linkyoutube" value="{{$webinar->link_youtube}}" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Title">
        </div>
